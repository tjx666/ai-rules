...
/**
 * Send system reminder to stderr
 * @param {string} message - Message to send
 */
function sendSystemReminder(message) {
  const reminder = generateSystemReminder(message);
...
/**
 * Send multiple suggestions as system reminder
 * @param {Array<Object>} suggestions - Array of suggestion objects
 */
function sendSuggestions(suggestions) {
